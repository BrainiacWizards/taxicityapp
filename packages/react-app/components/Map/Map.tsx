		...
		return (
			<>
				{props.pois.map((poi: iRank, index: number) => (
					<AdvancedMarker key={index} position={poi.location} clickable title={poi.name}>
						<Pin background={'#b90000'} glyphColor={'#ffffff'} borderColor={'#000'} />
	...
	return (
		<APIProvider
			...
			<Map
				...
				defaultCenter={locations[0]?.location || { lat: -33.904139, lng: 18.630222 }}
				colorScheme='dark'
				defaultZoom={10}
